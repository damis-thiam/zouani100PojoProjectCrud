...
export class DisciplineScientifiqueService {
    private API = ''
     constructor(private http: HttpClient, private roleService: RoleService) {
        ...
        this.role$.subscribe(role => {
            this.API = 'http://localhost:8036/api/' + role + '/disciplineScientifique/';
        })
    }
     private _disciplineScientifiques: Array<DisciplineScientifiqueVo> = [];
     private _selectedDisciplineScientifique: DisciplineScientifiqueVo = new DisciplineScientifiqueVo();
     ...
     private _searchDisciplineScientifique:DisciplineScientifiqueVo = new DisciplineScientifiqueVo();
    ...
    get disciplineScientifiques(): Array<DisciplineScientifiqueVo> {
        return this._disciplineScientifiques == null ? this._disciplineScientifiques =   new Array<DisciplineScientifiqueVo>() : this._disciplineScientifiques;
       }
    ...
    public save(): Observable<DisciplineScientifiqueVo> {
         return this.http.post<DisciplineScientifiqueVo>(this.API, this.selectedDisciplineScientifique);
    }
