...
export class CommunauteSavoirService {
    private API = ''
     constructor(private http: HttpClient, private roleService: RoleService) {
        ...
        this.role$.subscribe(role => {
            this.API = 'http://localhost:8036/api/' + role + '/communauteSavoir/';
        })
    }
     private _communauteSavoirs: Array<CommunauteSavoirVo> = [];
     private _selectedCommunauteSavoir: CommunauteSavoirVo = new CommunauteSavoirVo();
     ...
     private _searchCommunauteSavoir:CommunauteSavoirVo = new CommunauteSavoirVo();
    ...
    get communauteSavoirs(): Array<CommunauteSavoirVo> {
        return this._communauteSavoirs == null ? this._communauteSavoirs =   new Array<CommunauteSavoirVo>() : this._communauteSavoirs;
       }
    ...
    public save(): Observable<CommunauteSavoirVo> {
         return this.http.post<CommunauteSavoirVo>(this.API, this.selectedCommunauteSavoir);
    }
