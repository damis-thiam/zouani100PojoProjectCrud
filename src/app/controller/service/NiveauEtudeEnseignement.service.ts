...
export class NiveauEtudeEnseignementService {
    private API = ''
     constructor(private http: HttpClient, private roleService: RoleService) {
        ...
        this.role$.subscribe(role => {
            this.API = 'http://localhost:8036/api/' + role + '/niveauEtudeEnseignement/';
        })
    }
     private _niveauEtudeEnseignements: Array<NiveauEtudeEnseignementVo> = [];
     private _selectedNiveauEtudeEnseignement: NiveauEtudeEnseignementVo = new NiveauEtudeEnseignementVo();
     ...
     private _searchNiveauEtudeEnseignement:NiveauEtudeEnseignementVo = new NiveauEtudeEnseignementVo();
    ...
    get niveauEtudeEnseignements(): Array<NiveauEtudeEnseignementVo> {
        return this._niveauEtudeEnseignements == null ? this._niveauEtudeEnseignements =   new Array<NiveauEtudeEnseignementVo>() : this._niveauEtudeEnseignements;
       }
