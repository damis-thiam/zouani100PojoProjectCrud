...
export class CommunauteSavoirEncadrementEtudiantService {
    private API = ''
     constructor(private http: HttpClient, private roleService: RoleService) {
        ...
        this.role$.subscribe(role => {
            this.API = 'http://localhost:8036/api/' + role + '/communauteSavoirEncadrementEtudiant/';
        })
    }
     private _communauteSavoirEncadrementEtudiants: Array<CommunauteSavoirEncadrementEtudiantVo> = [];
     private _selectedCommunauteSavoirEncadrementEtudiant: CommunauteSavoirEncadrementEtudiantVo = new CommunauteSavoirEncadrementEtudiantVo();
     ...
     private _searchCommunauteSavoirEncadrementEtudiant:CommunauteSavoirEncadrementEtudiantVo = new CommunauteSavoirEncadrementEtudiantVo();
    ...
    get communauteSavoirEncadrementEtudiants(): Array<CommunauteSavoirEncadrementEtudiantVo> {
        return this._communauteSavoirEncadrementEtudiants == null ? this._communauteSavoirEncadrementEtudiants =   new Array<CommunauteSavoirEncadrementEtudiantVo>() : this._communauteSavoirEncadrementEtudiants;
       }
