...
export class IdentifiantRechercheService {
    private API = ''
     constructor(private http: HttpClient, private roleService: RoleService) {
        ...
        this.role$.subscribe(role => {
            this.API = 'http://localhost:8036/api/' + role + '/identifiantRecherche/';
        })
    }
     private _identifiantRecherches: Array<IdentifiantRechercheVo> = [];
     private _selectedIdentifiantRecherche: IdentifiantRechercheVo = new IdentifiantRechercheVo();
     ...
     private _searchIdentifiantRecherche:IdentifiantRechercheVo = new IdentifiantRechercheVo();
    ...
    get identifiantRecherches(): Array<IdentifiantRechercheVo> {
        return this._identifiantRecherches == null ? this._identifiantRecherches =   new Array<IdentifiantRechercheVo>() : this._identifiantRecherches;
       }
    ...
    public save(): Observable<IdentifiantRechercheVo> {
         return this.http.post<IdentifiantRechercheVo>(this.API, this.selectedIdentifiantRecherche);
    }
